...
- **Source:** [YouTube](https://www.youtube.com/watch?v=g6bOwQdCJrc)
- **Author:** WAD at CVPR
- **Subscribers:** 4.61K subscribers
- **Date:** Jun 24, 2021
- **Views:** 50,212 views
- **Video ID:** g6bOwQdCJrc
...
这是安德烈在 CVPR（一个很重要的计算机视觉大会）上做的主题演讲，讲的是特斯拉如何用 AI 实现"完全自动驾驶"。他解释了特斯拉的汽车是怎么"看"路的——车上的摄像头就像眼睛一样，把看到的东西传给一个"电子大脑"（神经网络）来分析。他还讲到了他们在训练这些"大脑"时遇到的挑战，比如怎么让车在从来没有见过的路况下也能安全驾驶。
